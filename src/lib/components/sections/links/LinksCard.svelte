...
<section id="links" class="bg-base-200/50 px-4 py-16">
		...
		<div class="grid gap-4 md:grid-cols-2">
			{#each data.items as link}
				<a
					...
					class="card bg-base-100 shadow-md transition-all hover:shadow-xl"
				>
					<div class="card-body flex-row items-center gap-4 p-6">
						<span class="h-8 w-8 shrink-0 text-primary">{@html getIcon(link.icon)}</span>
